    ...
    <div className="relative min-h-screen font-sans overflow-hidden flex items-start justify-center p-4 pt-28">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full">
        ...
        <div className="mt-6 text-center">
          <Link to="/forgot-password" className="text-white font-semibold hover:text-gray-200 transition-colors" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.7)' }}>
            Forgot Password?
          </Link>
          <p className="text-white mt-4" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.7)' }}>
