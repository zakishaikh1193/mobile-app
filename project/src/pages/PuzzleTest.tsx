...
const PuzzleTest: React.FC = () => {
  const [selectedPuzzle, setSelectedPuzzle] = useState<number>(12); // Use the puzzle we created
  const [childId, setChildId] = useState<number>(1);

  const samplePuzzles = [
    {
      id: 12,
      title: 'Simple Animal Puzzle',
      difficulty: 'easy',
      description: 'A fun puzzle for young learners'
    }
  ];

  const handleComplete = (completionData: any) => {
    console.log('Puzzle completed:', completionData);
    alert(`Puzzle completed! Score: ${completionData.score}`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">🧩 Puzzle Game Test</h1>
          <p className="text-lg text-gray-600 mb-6">
            Test the puzzle game functionality with different difficulty levels
          </p>
        ...
        <div className="mt-8 bg-white rounded-lg p-6 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• <strong>Drag & Drop:</strong> Move puzzle pieces to their correct positions</li>
                <li>• <strong>Preview:</strong> Click the eye icon to see the complete image</li>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="space-y-1 text-blue-700">
              <li>• Start with corner pieces to establish the frame</li>
              <li>• Look for distinctive features in the image</li>
              <li>• Use the preview feature if you get stuck</li>
              <li>• Try to complete the puzzle quickly for bonus points</li>
            </ul>
          </div>
        </div>
      </div>
